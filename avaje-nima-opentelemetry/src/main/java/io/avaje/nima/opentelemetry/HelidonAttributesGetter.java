...
final class HelidonAttributesGetter implements HttpServerAttributesGetter<ServerRequest, ServerResponse> {
    ...
    @Override
    public Integer getHttpResponseStatusCode(ServerRequest req, ServerResponse res, @Nullable Throwable error) {
    ...
    @Override
    @Nullable
    public InetSocketAddress getNetworkPeerInetSocketAddress(ServerRequest req, @Nullable ServerResponse res) {
    ...
    @Override
    @Nullable
    public InetSocketAddress getNetworkLocalInetSocketAddress(ServerRequest req, @Nullable ServerResponse res) {
